            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <p className="mb-9 text-base font-medium leading-relaxed text-body-color">
                 Championing global innovation, Genfinity Global ignites visionary collaboration for a sustainable tomorrow. We unite expertise, fuel innovation, and forge impactful alliances, driving transformative change across industries.
                </p>
                <div className="flex items-center">
                  ...
                  target="_blank"
                  rel="noreferrer"
                    href="https://www.linkedin.com/company/genfinity-global/mycompany/"
                    aria-label="social-link"
                    className="mr-6 text-[#CED3F6] hover:text-primary"
                  >
                    <svg
        ...
        <div className="bg-primary/10 py-8">
          <div className="container">
            <p className="text-center text-base text-body-color dark:text-white">
              Copyright © 2024 All rights reserved | GENFINITY GLOBAL
            </p>
          </div>
        </div>
